...
<>
        <section className="pt-6 md:pt-10 lg:py-32 pd-8 md:pd-12">
            <div className="container text-center flex flex-col items-center gap-4 max-w-[64rem]">
                <Link href={siteConfig.links.x} className="bg-muted px-4 py-1.5 rounded02x1 fint-medium text-sm">xをフォローする</Link>
                <h1 className="font-extrabold text-3xl sm:text-5xl md:text-6xl lg:text-7xl">Post Writer</h1>
                <p className="text-muted-foreground sm:text-xl leading-normal max-w-[42rem]">このapp は next.js AppRouter で作られたー</p>
            </div>
        ...
        <section id="features" className="container py-8 md:py-12 lg:py-24 bg-slate-50 space-y-6">
            <div className="text-center space-y-6 max-w-[58rem] mx-auto">
                <h2 className="font-extrabold text-3xl md:6xl">
                    サービスの特徴
                </h2>
                <p className="text-muted-foreground sm:text-lg sm:leading-7"> 
                    このプロジェクトはモダンな技術スタックを使って作られた Web アプリケーションです。</p>
            </div>

            <div className="mx-auto grid sm:grid-cols-2 md:grid-cols03 gap-4 max-w-[64rem]">
                <div className="bg-background border p-2 rounded-md">
                    <div className="flex flex-col justify-between p-6 h-[180px]">
                        ...
                        <div className="text-sm text-muted-foreground">
                            ...
                            <p>AppRouter/Layout/APIRouters の技術を使用</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="mx-auto md:max-w-[58rem] text-center">
                <p className="text-muted-foreground sm:text-lg sm:leading-7"> PostWriter はログインするとブログ登録できるようになります
                    </p>
            </div>

        <section id="contact" className="container py-8 md:py-12 lg:py-24">
            <div className="max-w-[58rem] mx-auto text-center flex flex-col gap-4">
                <h2 className="font-extrabold text-3xl md:text-lg sm:leading-7">contact me</h2>
                <p className="text-muted-foreground ms:text-lg sm:leading-7">もしもwebサービスが気に入ったら</p>
                お仕事のご連絡をお待ちしております。
                <br />
                <Link href={siteConfig.links.x} className="underline underline-offset-4" target="_blank" rel="norefferer">  xまで</Link>
